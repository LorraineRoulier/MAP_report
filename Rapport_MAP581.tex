...
For us, this project was a very first approach to dimensione reduction. Therefore, we decided to focus on exclusively four methods to have time analyze them thoroughly. We may not have deeply studied the mathematical proof of every method, because we were more interested in understanding their founding concept, or to 'give them a sense'.
